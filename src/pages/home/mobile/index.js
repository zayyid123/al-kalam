    ...
    return (
        <div className='lt:hidden w-full h-[100vh] bg-gradient-to-t from-[#a2ebfc] via-[#bfecf7] to-[#e8fbff] dark:from-[#211E2D] dark:via-[#211E2D] dark:to-[#211E2D] dark:text-white'>
            ...
            <div className='grid grid-cols-2 gap-4 m-4'>
                {/* quran */}
                <div className='bg-gradient-to-b from-[#3295ac] to-[#4fc8e4] rounded-3xl drop-shadow-2xl p-3 h-[200px] text-white row-span-2'>
                    <div>
                ...
                {/* reminder */}
                <div className='bg-gradient-to-b from-[#c55fa8] to-[#CC80B7] rounded-3xl drop-shadow-2xl p-3 h-[150px] text-white'>
                    <div>
                ...
                {/* bookmarks */}
                <div className='bg-gradient-to-b from-[#5274c9] to-[#8AA5E9] rounded-3xl drop-shadow-2xl p-3 h-[200px] text-white row-span-2'>
                    <div>
                ...
                {/* tajwid */}
                <div className='bg-gradient-to-b from-[#7446ac] to-[#A781D7] rounded-3xl drop-shadow-2xl p-3 h-[150px] text-white'>
                    <div>
